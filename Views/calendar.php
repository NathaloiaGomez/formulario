              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div id="external-events">
                    ...
                    <div class="external-event bg-warning">Ir a hogar </div>
                    <div class="external-event bg-info">hacer la tarea</div>
                    <div class="external-event bg-primary">Trabajar en el diseño de la interfaz de usuario.</div>
                    <div class="external-event bg-danger">Que duermas bien </div>
                    <div class="checkbox">
